...
<body>
    ...
    <div class="edit-container">
        ...
        <div class="edit-sidebar">
            <div class="sidebar-header">
                ...
                <h2 class="sidebar-title">Trình chỉnh sửa bài đăng</h2>
            </div>
            ...
            <div class="sidebar-section">
                <div class="section-card active" onclick="showSection('photos')" style="border: 2px solid #000; background: #f8f9fa;">
                    <div class="section-title">Tour tham quan qua ảnh</div>
                    <div class="section-content">1 phòng ngủ - 1 giường - 1 phòng tắm</div>
            ...
            <div class="sidebar-section">
                <div class="section-card" onclick="showSection('type')">
                    <div class="section-title">Loại chỗ ở</div>
                    <div class="section-content">Toàn bộ nhà - Nhà</div>
                    <span class="section-arrow">></span>
                </div>
            </div>
            ...
            <div class="sidebar-section">
                <div class="section-card" onclick="showSection('pricing')">
                    <div class="section-title">Định giá</div>
                    <div class="section-content">₫${listing.pricePerNight}/đêm</div>
                    <span class="section-arrow">></span>
                </div>
            </div>
        ...
        <div class="edit-main">
            ...
            <div id="photos-content" class="content-card">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                    <h3 class="content-title">Tour tham quan qua ảnh</h3>
                    <button id="save-photos-btn" class="btn btn-primary" style="background: #000; color: white; border: none; padding: 8px 16px; border-radius: 6px;" onclick="savePhotos()">Lưu</button>
                </div>
                ...
                <div class="photo-grid" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(150px, 1fr)); gap: 15px; margin-bottom: 30px;">
                    ...
                    <div class="add-photo-btn" onclick="addNewPhoto()" style="border: 2px dashed #ddd; border-radius: 8px; height: 120px; display: flex; flex-direction: column; align-items: center; justify-content: center; cursor: pointer; background: #f8f9fa; transition: all 0.3s ease;">
                        ...
                        <div style="font-size: 12px; color: #666;">Thêm ảnh</div>
                    </div>
                </div>
                ...
                <div id="photo-upload-form" style="display: none; background: white; border: 1px solid #ddd; border-radius: 8px; padding: 20px; margin-top: 20px;">
                    <h4 style="margin-bottom: 15px;">Thêm ảnh mới</h4>
                    <form id="uploadForm" enctype="multipart/form-data">
                        <input type="hidden" id="listingIdInput" name="listingId" value="${listing.listingID}">
                        <div style="margin-bottom: 15px;">
                            <label style="display: block; margin-bottom: 5px; font-weight: 600;">Chọn ảnh:</label>
                        ...
                        <div id="image-preview-area" style="display: none; margin-bottom: 15px;">
                            <h5 style="margin-bottom: 10px;">Ảnh đã chọn:</h5>
                        ...
                        <div style="display: flex; gap: 10px; justify-content: flex-end;">
                            <button type="button" class="btn btn-secondary" onclick="cancelUpload()">Hủy</button>
            ...
            <div id="title-content" class="form-content">
                <h3 class="content-title">Chỉnh sửa tiêu đề</h3>
                <form method="post" action="${pageContext.request.contextPath}/host/listing/edit">
                    ...
                    <div class="form-actions">
                        <button type="button" class="btn btn-secondary" onclick="showSection('photos')">Hủy</button>
    ...
    <script>
        ...
        function createPhotoTour() {
            alert('Tính năng tạo tour tham quan qua ảnh sẽ được phát triển trong tương lai!');
        }
        ...
        function uploadImages() {
            ...
            alert('Ảnh đã được thêm vào danh sách. Nhấn "Lưu" để xác nhận thay đổi.');
        }
        ...
        function editPhoto(index) {
            alert('Chỉnh sửa ảnh số ' + (parseInt(index) + 1) + ' - Tính năng này sẽ được phát triển!');
        }
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (updated !== null) {
                ...
                showToast(success ? 'Lưu thành công' : 'Lưu không thành công', success ? 'success' : 'error');
        ...
        function deleteImage(listingId, imageUrl, elementId) {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    alert('Không thể xoá ảnh: ' + (data.message || 'Lỗi'));
                }
            })
            .catch(err => {
