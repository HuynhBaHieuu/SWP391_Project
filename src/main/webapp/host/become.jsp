                    ...
                    <form method="post" action="${pageContext.request.contextPath}/become-host" id="detailForm">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="idType" class="form-label">
                                        <i class="fas fa-id-card me-2"></i>ID Type <span class="text-danger">*</span>
                                    </label>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="idNumber" class="form-label">
                                        <i class="fas fa-hashtag me-2"></i>ID Number <span class="text-danger">*</span>
                                    </label>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="bankName" class="form-label">
                                        <i class="fas fa-university me-2"></i>Bank Name <span class="text-danger">*</span>
                                    </label>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="bankAccount" class="form-label">
                                        <i class="fas fa-credit-card me-2"></i>Bank Account Number <span class="text-danger">*</span>
                                    </label>
                        ...
                        <div class="mb-3">
                            <label for="experience" class="form-label">
                                <i class="fas fa-briefcase me-2"></i>Work Experience <span class="text-danger">*</span>
                            </label>
