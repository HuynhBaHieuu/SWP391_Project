...
<head>
  <meta charset="UTF-8">
  <title data-i18n="host.become_host.title">Trở thành host</title>
...
<body>
  <div class="container mt-5">
    ...
    <c:if test="${status == 'pending'}">
      <div class="status-card">
        ...
        <h3 data-i18n="host.become_host.request_pending">Yêu cầu đang chờ duyệt</h3>
    ...
    <c:if test="${status != 'pending'}">
      ...
      <div id="step1" class="step-content">
        <h4 class="mb-3" data-i18n="host.become_host.step1_title">Bước 1: Thông tin xác minh danh tính</h4>
        <p class="text-muted mb-4" data-i18n="host.become_host.step1_desc">Vui lòng cung cấp thông tin chi tiết để admin có thể xác minh danh tính của bạn.</p>
        ...
        <form method="post" action="${pageContext.request.contextPath}/become-host" id="detailForm">
            ...
            <div class="col-md-6">
              <div class="mb-3">
                <label for="phoneNumber" class="form-label">
                  <i class="fas fa-phone me-2"></i><span data-i18n="host.become_host.phone_number">Số điện thoại</span> <span class="text-danger">*</span>
                </label>
          ...
          <div class="mb-3">
            <label for="address" class="form-label">
              <i class="fas fa-map-marker-alt me-2"></i><span data-i18n="host.become_host.permanent_address">Địa chỉ thường trú</span> <span class="text-danger">*</span>
            </label>
            <textarea class="form-control" id="address" name="address" rows="2" required
                      placeholder="Nhập địa chỉ đầy đủ bao gồm số nhà, đường, phường/xã, quận/huyện, tỉnh/thành phố" data-i18n-attr="placeholder:host.become_host.address_placeholder"></textarea>
          </div>
            ...
            <div class="col-md-6">
              <div class="mb-3">
                <label for="idType" class="form-label">
                  <i class="fas fa-id-card me-2"></i><span data-i18n="host.become_host.id_type">Loại giấy tờ tùy thân</span> <span class="text-danger">*</span>
                </label>
                <select class="form-select" id="idType" name="idType" required>
                  <option value="" data-i18n="host.become_host.select_id_type">Chọn loại giấy tờ</option>
                  <option value="CCCD" data-i18n="host.become_host.citizen_id">Căn cước công dân</option>
                  <option value="CMND" data-i18n="host.become_host.national_id">Chứng minh nhân dân</option>
                  <option value="PASSPORT" data-i18n="host.become_host.passport">Hộ chiếu</option>
                </select>
              </div>
            </div>
            <div class="col-md-6">
              <div class="mb-3">
                <label for="idNumber" class="form-label">
                  <i class="fas fa-hashtag me-2"></i><span data-i18n="host.become_host.id_number">Số giấy tờ tùy thân</span> <span class="text-danger">*</span>
                </label>
            ...
            <div class="col-md-6">
              <div class="mb-3">
                <label for="bankName" class="form-label">
                  <i class="fas fa-university me-2"></i><span data-i18n="host.become_host.bank_name">Tên ngân hàng</span> <span class="text-danger">*</span>
                </label>
                <select class="form-select" id="bankName" name="bankName" required>
                  <option value="" data-i18n="host.become_host.select_bank">Chọn ngân hàng</option>
            ...
            <div class="col-md-6">
              <div class="mb-3">
                <label for="bankAccount" class="form-label">
                  <i class="fas fa-credit-card me-2"></i><span data-i18n="host.become_host.bank_account">Số tài khoản ngân hàng</span> <span class="text-danger">*</span>
                </label>
          ...
          <div class="mb-3">
            <label for="experience" class="form-label">
              <i class="fas fa-briefcase me-2"></i><span data-i18n="host.become_host.work_experience">Kinh nghiệm làm việc</span> <span class="text-danger">*</span>
            </label>
            <textarea class="form-control" id="experience" name="experience" rows="3" required
                      placeholder="Mô tả kinh nghiệm làm việc, nghề nghiệp hiện tại của bạn..." data-i18n-attr="placeholder:host.become_host.experience_placeholder"></textarea>
          </div>
          
          <div class="mb-3">
            <label for="motivation" class="form-label">
              <i class="fas fa-heart me-2"></i><span data-i18n="host.become_host.motivation">Lý do muốn trở thành host</span> <span class="text-danger">*</span>
            </label>
            <textarea class="form-control" id="motivation" name="motivation" rows="3" required
                      placeholder="Chia sẻ lý do và động lực của bạn khi muốn trở thành host..." data-i18n-attr="placeholder:host.become_host.motivation_placeholder"></textarea>
          </div>
          
          <div class="d-flex justify-content-end">
            <button type="submit" class="btn btn-primary">
              <i class="fas fa-arrow-right me-2"></i><span data-i18n="host.become_host.next">Tiếp theo</span>
            </button>
          </div>
        </form>
      </div>
      ...
      <div id="step2" class="step-content" style="display: none;">
        <h4 class="mb-3" data-i18n="host.become_host.step2_title">Bước 2: Chọn dịch vụ bạn muốn cung cấp</h4>
    ...
    <div class="grid" id="options">
      <label class="card">
        <div class="emoji">🏠</div>
        <div><strong data-i18n="host.become_host.accommodation">Nơi lưu trú</strong></div>
        <input class="hide" type="radio" name="serviceType" value="ACCOMMODATION">
      </label>
      <label class="card">
        <div class="emoji">🎈</div>
        <div><strong data-i18n="host.become_host.experience">Trải nghiệm</strong></div>
        <input class="hide" type="radio" name="serviceType" value="EXPERIENCE">
      </label>
      <label class="card">
        <div class="emoji">🛎️</div>
        <div><strong data-i18n="host.become_host.service">Dịch vụ</strong></div>
        <input class="hide" type="radio" name="serviceType" value="SERVICE">
          ...
          <div class="message-box">
            <label for="message" class="form-label">
              <i class="fas fa-comment me-2"></i><span data-i18n="host.become_host.message_admin">Tin nhắn cho admin (tùy chọn)</span>
            </label>
            <textarea class="form-control" id="message" name="message" rows="3" 
                      placeholder="Hãy chia sẻ thêm về kinh nghiệm hoặc lý do bạn muốn trở thành host..." data-i18n-attr="placeholder:host.become_host.message_placeholder"></textarea>
          </div>
          
          <div class="d-flex justify-content-between">
            <button type="button" class="btn btn-outline-secondary" onclick="goBackToStep1()">
              <i class="fas fa-arrow-left me-2"></i><span data-i18n="host.become_host.back">Quay lại</span>
            </button>
            <button type="submit" class="btn btn-primary" id="submitBtn" disabled>
              <i class="fas fa-paper-plane me-2"></i><span data-i18n="host.become_host.submit_request">Gửi yêu cầu</span>
            </button>
    </div>
  </form>
      </div>
  ...
  <script>
    ...
    document.getElementById('detailForm').addEventListener('submit', function(e) {
      ...
      if (!isValid) {
        alert(I18N.t('host.become_host.fill_required'));
        return;
      }
