                        ...
                        <div class="booking-card">
                                ...
                                <div class="col-md-2">
                                    <c:choose>
                                        <c:when test="${not empty booking.listing.firstImage}">
                                            <img src="${booking.listing.firstImage}" class="booking-image"
                                        ...
                                        <c:otherwise>
                                            <div class="booking-image bg-light d-flex align-items-center justify-content-center"
                                                ...
                                                <small class="text-muted"
                                                    style="font-size: 10px; text-align: center; padding: 0 2px;">${booking.listingTitle}</small>
                                            </div>
                                        </c:otherwise>
                                    </c:choose>
                                </div>
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-4 text-end">
                                    <a href="${pageContext.request.contextPath}/booking?action=detail&bookingId=${booking.bookingID}"
