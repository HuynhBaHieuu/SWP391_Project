...
<footer class="ab-footer" role="contentinfo">
    ...
    <div class="ab-footer__links container">
        ...
        <nav class="col" aria-label="GO2BNB">
            <h3>GO2BNB</h3>
            <ul>
                <li><a href="<%=request.getContextPath()%>/go2bnb_footer/go2bnb_release/release.jsp">Bản phát hành Mùa hè 2025</a></li>
                <li><a href="<%=request.getContextPath()%>/go2bnb_footer/go2bnb_news/news.jsp">Trang tin tức</a></li>
                <li><a href="<%=request.getContextPath()%>/go2bnb_footer/go2bnb_careers/careers.jsp">Cơ hội nghề nghiệp</a></li>
                <li><a href="#">Nhà đầu tư</a></li>
                <li><a href="<%=request.getContextPath()%>/go2bnb_footer/go2bnb_support/support.jsp">Chỗ ở khẩn cấp GO2BNB.org</a></li>
            </ul>
        </nav>
    </div>
